...
# region Initialized PyGame Framework
pygame.init()
# endregion
...
pygame.display.set_caption("00 - Study Game Snake")
# endregion
...
# region Fonts Configs
font_base = 'Century Gothic'
message_font = pygame.font.SysFont(font_base, 30)
score_font = pygame.font.SysFont(font_base, 24)
# endregion
...
def draw_snake(snake_size, snake_pixels):
    for pixels in snake_pixels:
        pygame.draw.rect(game_display, white, [
                         pixels[0], pixels[1], snake_size, snake_size])
# endregion
    ...
    while not game_over:
        ...
        if x == target_x and y == target_y:
            target_x = round(random.randrange(
                0, width - snake_size) / 10.0) * 10
            target_y = round(random.randrange(
                0, height - snake_size) / 10.0) * 10
            snake_length += 1
